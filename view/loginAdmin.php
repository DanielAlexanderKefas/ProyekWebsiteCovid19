...
<div class="flex-container">
    <form class="login-form" method="post" action="#" style="width: 40%">
        <div style="display: flex; justify-content: center; width: 100%;">
            <h2 style="margin: 0px; font-weight: bold;">Admin Log In<h2>
        </div>
        <p></p>
        <div style="font-weight: bold;">Username</div>
        <input class="txtbox" type="text" placeholder="Type your username here" name="username" style="width: 100%; padding: 5px;">
        <p></p>
        <div style="font-weight: bold;">Password</div>
        <input class="txtbox" type="password" placeholder="Type your password here" name="password" style="width: 100%; padding: 5px;">
        <p></p>
